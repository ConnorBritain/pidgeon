    ...
    public override Command CreateCommand()
    {
        ...
        SetCommandAction(command, async (parseResult, cancellationToken) =>
        {
            try
            {
                ...
                Console.WriteLine($"🔍 Pidgeon Find - {GetSearchModeDescription(searchMode)}");
                Console.WriteLine("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    ...
    private async Task ShowSearchSuggestionsAsync(string query, SearchMode searchMode)
    {
        ...
        switch (searchMode)
        {
            case SearchMode.Field:
                Console.WriteLine("  • Try broader field names: 'patient', 'encounter', 'medication'");
                Console.WriteLine("  • Use standard prefixes: 'PID.', 'Patient.', 'NewRx.'");
                Console.WriteLine("  • Check spelling and use dots/hyphens for paths");
                break;

            case SearchMode.Value:
                Console.WriteLine("  • Ensure the value exists in your sample files");
                Console.WriteLine("  • Try searching in specific directories with --in");
                Console.WriteLine("  • Use quotes for values with spaces");
                break;

            case SearchMode.Semantic:
                Console.WriteLine("  • Try related terms: 'patient name', 'birth date', 'medical record'");
                Console.WriteLine("  • Use clinical terminology: 'diagnosis', 'procedure', 'allergy'");
                Console.WriteLine("  • Be more specific: 'prescription medication' vs 'medication'");
                break;

            default:
                Console.WriteLine("  • Try different search modes: --field, --value, --map");
                Console.WriteLine("  • Use --pattern for wildcard searches");
                Console.WriteLine("  • Check available standards with 'pidgeon lookup --help'");
                break;
        }
