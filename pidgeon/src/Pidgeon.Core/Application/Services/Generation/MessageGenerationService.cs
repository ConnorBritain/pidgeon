...
internal class MessageGenerationService : IMessageGenerationService
{
    ...
    public async Task<Result<IReadOnlyList<string>>> GenerateSyntheticDataAsync(string standard, string messageType, int count = 1, Pidgeon.Core.Generation.GenerationOptions? options = null)
    {
        try
        {
            var messages = new List<string>();
            var generationOptions = options ?? new Pidgeon.Core.Generation.GenerationOptions();
    ...
    private async Task<Result<string>> GeneratePatientMessageAsync(string standard, Pidgeon.Core.Generation.GenerationOptions options)
    {
    ...
    private async Task<Result<string>> GenerateMedicationMessageAsync(string standard, Pidgeon.Core.Generation.GenerationOptions options)
    {
    ...
    private async Task<Result<string>> GeneratePrescriptionMessageAsync(string standard, Pidgeon.Core.Generation.GenerationOptions options)
    {
    ...
    private async Task<Result<string>> GenerateEncounterMessageAsync(string standard, Pidgeon.Core.Generation.GenerationOptions options)
    {
